...
const multiSelectVariants = cva(
  'm-1 transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110',
  {
    variants: {
      variant: {
        default: 'border-primary/10 bg-primary font-normal text-primary-foreground hover:bg-card/80',
      ...
      <Popover open={isPopoverOpen} onOpenChange={setIsPopoverOpen} modal={modalPopover}>
        <PopoverTrigger asChild>
          <Button
            ...
            className={cn(
              'flex w-full p-1 rounded-md border font-normal border-input focus:bg-accent focus:text-accent-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 min-h-10 h-auto items-center justify-between [&_svg]:pointer-events-auto',
              className
            )}
          >
